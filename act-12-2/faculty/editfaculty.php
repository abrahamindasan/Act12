    ...
    */
    ...
    if(isset($_POST['edit'])){
        ...
        if ($faculty->fetch($_GET['id'])){
            ...
            $_POST['fn'] = $data['firstname'];
            $_POST['ln']= $data['lastname'];
            $_POST['email'] = $data['email'];
            $_POST['rank'] = $data['academic_rank'];
            $_POST['department'] = $data['department'];
            $_POST['role'] = $data['admission_role'];
    ...
    <div class="home-content">
        <div class="table-container">
            ...
            <div class="add-form-container">
                <form class="add-form" action="editfaculty.php?id=<?php echo $_GET['id']?>" method="post">
                    ...
                    <input type="submit" class="button" value="Edit Faculty" name="edit" id="edit">
                </form>
            </div>
        </div>
    </div>
